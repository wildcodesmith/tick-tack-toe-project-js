...
let k = (e)=>{
        if(turn=="A"){
            ...
            if(searchAray(wh1,moves_a) || searchAray(wh2,moves_a)|| searchAray(wh3,moves_a)|| searchAray(wv1,moves_a)|| searchAray(wv2,moves_a)|| searchAray(wv3,moves_a)|| searchAray(wd1,moves_a)|| searchAray(wd2,moves_a)){
            ...
            if(searchAray(wh1,moves_b) || searchAray(wh2,moves_b)|| searchAray(wh3,moves_b)|| searchAray(wv1,moves_b)|| searchAray(wv2,moves_b)|| searchAray(wv3,moves_b)|| searchAray(wd1,moves_b)|| searchAray(wd2,moves_b)){
                console.log("b is winner.")
                 wrapper.style.display = "none";
                h.innerText = "B is winner"
